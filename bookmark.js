let bookmarks = [
  ...
  },
  {
    ...
    url: "https://covid19dashboard-by-nikhil.netlify.app/",
  },
];
...
function createAndAppendBookmark(bookmark) {
  let { bookmarkId, name, url } = bookmark;

  let listItem = document.createElement("li");
  listItem.classList.add("list-item", "mb-2");
  listItem.id = bookmarkId;

  let bookmarkContainer = document.createElement("div");
  bookmarkContainer.classList.add(
    "d-flex",
    "flex-row",
    "bg-light",
    "rounded",
...
createAndAppendBookmark(bookmarks[1]);
